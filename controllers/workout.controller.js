...
const createWorkout = async (req, res) => {
	...
	const foundUser = {_id: 194872, experienceLevel: 17}


	const workout = await Workout.create({userId: foundUser.id})

	const workoutList = await workout.generateExercisesList(foundUser.experienceLevel)
